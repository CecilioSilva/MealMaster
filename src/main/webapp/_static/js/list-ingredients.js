        ...
        data.forEach((ingredient) => {
          ingredientContainer.innerHTML += `
                            <div class="item-card">
                              ...
                              <p class="card-description">${clipText(
                                ingredient.description,
                                50
                              )}</p>
                              <img onclick="deleteIngredient('${
                                ingredient.id
                              }')" class="item-close" src="/_static/images/trash.svg" alt="Delete ingredient" aria-label="Delete item" aria-roledescription="Deletes the item">
                            </div>
                            `;
        });
      }, 100);
